...
{
    public sealed class ActionModelService
        : BaseService<ActionModelDto, ActionModel>, IActionModelService
    {
        public ActionModelService(IActionModelRepository repository, IMapper mapper)
